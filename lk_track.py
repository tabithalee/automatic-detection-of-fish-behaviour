...
class App:
    def __init__(self, video_src):
        ...
        self.numBins = 16
        self.histRange = np.arange(0, 2 * math.pi + (2*math.pi/numBins), 2*math.pi/numBins)
        ...
        while True:
            ...
            if _ret:
                ...
                if len(self.tracks) > 0:
                    ...
                    cartToPolar...
                    self.frameHist, _bins = np.histogram(ang, bins=myRange, weights=hsv[..., 2], density=False)
